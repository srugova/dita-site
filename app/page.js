export const metadata = {
  ...
  description:
    "A lean team of senior data operators helping companies turn data into real business outcomes. Based in Jakarta.",
  openGraph: {
    title: "Dita Data — Data & AI Consulting",
    description: "A lean team of senior data operators helping companies turn data into real business outcomes.",
    url: "https://dita.id",
    siteName: "Dita Data",
    type: "website",
  },
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .svc-btn-meet:hover { background: ${ACCENT}40; }
        ...
        .team-meet-link:hover { opacity: 0.65; }
        .team-network-note {
          background: ${ACCENT_BG};
          border: 1px solid ${ACCENT};
          border-radius: 14px;
        ...
        @media (max-width: 768px) {
          ...
          .team-founder-card { flex-direction: column; gap: 20px; }
      ...
      <div className="services-page">
        ...
        <nav className="svc-nav">
          ...
          <div className="svc-nav-links">
            ...
            <a href="#team" className="svc-nav-link">Team</a>
            <a href="#about" className="svc-nav-link">About</a>
            <a href="/me" className="svc-btn-meet">Meet Dita →</a>
        ...
        <section className="svc-section">
          <div className="svc-container">
            ...
            <div className="svc-btn-row">
              ...
              <a href="#services" className="svc-btn-outline">See what we offer</a>
            </div>
          </div>
        </section>
            ...
            <div className="steps-grid">
              <div>
                ...
                <p className="step-body">
                  Book a free Data Chat. Tell us what&apos;s broken, what you&apos;re trying to do,
                  and what you&apos;ve already tried.
                </p>
              </div>
              <div>
                <p className="step-num">02</p>
                <p className="step-title">We send a plan</p>
                <p className="step-body">
                  If it makes sense to work together, we&apos;ll send a short proposal — scope,
              ...
              <div>
                ...
                <p className="step-body">
                  We get to work. You get updates. No radio silence. No surprise pivots.
              ...
              <div>
                ...
                <p className="step-body">
                  ...
                  We set it up so your team can actually maintain it.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* TEAM */}
        <section id="team" className="svc-section hiw-bg">
          <div className="svc-container">
            <p className="section-label">The people</p>
            <h2 className="section-headline">Who you&apos;re working with.</h2>

            <div className="team-founder-card">
              <div className="team-avatar">D</div>
              <div>
                <p className="team-founder-name">Dita Nurhadiyati</p>
                <p className="team-founder-title">Founder &amp; Lead Data Strategist</p>
                <p className="team-founder-bio">
                  Data lead with 10+ years of experience building production-ready data systems —
                  recommendation engines, data warehouses, and AI tools — at scale.
                  Monash data science graduate. Based in Jakarta.
                </p>
                <a href="/me" className="team-meet-link">See full profile →</a>
              </div>
            </div>

            <div className="team-network-note">
              <span className="team-network-icon">🤝</span>
              <span>
                <strong style={{ color: INK }}>+ our curated network of senior specialists</strong> — analytics engineers,
                ML practitioners, and data architects, each with 5+ years of hands-on experience.
                We bring in the right people for each engagement, not a permanent bench you pay for.
              </span>
            </div>
          </div>
        </section>
